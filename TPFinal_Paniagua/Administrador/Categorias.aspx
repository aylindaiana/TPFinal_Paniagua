<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Categorias.aspx.cs" Inherits="TPFinal_Paniagua.Administrador.Categorias" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel runat="server">
        <ContentTemplate>
            <asp:GridView ID="dgvCategoria" runat="server" AutoGenerateColumns="False" DataKeyNames="Id_Categoria" CssClass="table table-striped table-bordered table-hover" OnSelectedIndexChanged="dgvCategoria_SelectedIndexChanged" HeaderStyle-CssClass="table-dark" GridLines="None">
                <Columns>
                    <asp:BoundField DataField="Id_Categoria" HeaderText="Id" ReadOnly="True" SortExpression="Id" />
