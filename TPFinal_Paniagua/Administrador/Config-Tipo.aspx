<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Config-Tipo.aspx.cs" Inherits="TPFinal_Paniagua.Administrador.Config_Tipo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h1>Editar en Tipo</h1>

    <div class="form-container">
        <div class="row">
            <div class="mb-3">
                <label for="txtId" class="form-label">Id Tipo</label>
                <asp:TextBox runat="server" ID="txtId_Tipo" CssClass="form-control" placeholder="ID" ReadOnly="true" />
            </div>
