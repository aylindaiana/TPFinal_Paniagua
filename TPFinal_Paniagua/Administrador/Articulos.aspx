<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Articulos.aspx.cs" Inherits="TPFinal_Paniagua.Administrador.Articulos" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel runat="server">
        <ContentTemplate>
            <asp:GridView ID="dgvArticulos" runat="server" AutoGenerateColumns="False" DataKeyNames="Id_Articulo" CssClass="table table-striped table-bordered table-hover" OnSelectedIndexChanged="dgvArticulos_SelectedIndexChanged" HeaderStyle-CssClass="table-dark" GridLines="None">
                <Columns>
