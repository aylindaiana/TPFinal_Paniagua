<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UsuariosGeneral.aspx.cs" Inherits="TPFinal_Paniagua.Administrador.UsuariosGeneral" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel runat="server">
        <ContentTemplate>
            <asp:GridView ID="dgvUsuarios" runat="server" AutoGenerateColumns="False" DataKeyNames="Id_Usuario" CssClass="table table-striped table-bordered table-hover" OnSelectedIndexChanged="dgvUsuarios_SelectedIndexChanged" HeaderStyle-CssClass="table-dark" GridLines="None">
                <Columns>
                    <asp:BoundField DataField="Id_Usuario" HeaderText="Id" ReadOnly="True" SortExpression="Id" />
                    ...
                    <asp:BoundField DataField="IdAcceso" HeaderText="Tipo Acceso" SortExpression="IdAcceso" />
                    <asp:TemplateField>
                        <ItemTemplate>
